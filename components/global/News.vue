<template>
  ...
  <div class="relative bg-secondary-50 pt-16 pb-16 px-0 lg:py-20">
    <div class="absolute inset-0">
      <div class="bg-white h-1/3 sm:h-2/3 w-full"></div>
    </div>
    <div class="relative max-w-md px-4 sm:px-6 lg:max-w-7xl mx-auto lg:px-8 sm:max-w-3xl">
      <div class="text-center">
        <h2 class="text-3xl tracking-tight font-extrabold text-primary-500 sm:text-4xl">
          Lokaal Liberaal in het nieuws
        </h2>
